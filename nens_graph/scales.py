...
class RestrictToMonthScale(scale.ScaleBase):
    """Scales data to a specific repeating period in time."""
    pass


# Copied from http://matplotlib.sourceforge.net/api/axes_api.html
